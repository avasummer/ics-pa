...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, if(!src2)R(rd) = src1;else R(rd) = ((int32_t)src1 % (int32_t)src2));
  INSTPAT("0000001 ????? ????? 111 ????? 01110 11", remuw  , R, if(!src2)R(rd) = src1;else R(rd) = (int32_t)((uint32_t)src1 % (uint32_t)src2));
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, if(!src2)R(rd) = src1;else R(rd) = (uint64_t)src1 % (uint64_t)src2);
