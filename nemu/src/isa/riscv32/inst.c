...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 01110 11", remuw  , R, printf("%d",INT32_MIN);if(!src2)R(rd) = src1;else if(src1==INT32_MIN && src2==-1)R(rd)=src1;else R(rd) = (int32_t)((uint32_t)src1 % (uint32_t)src2));
